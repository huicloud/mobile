...
var RCTWebViewManager = require('NativeModules').DzhWebViewManager;
...
var JSNavigationScheme = RCTWebViewManager.DzhNavigationScheme;
...
var WebView = React.createClass({
  ...
  execute: function(js) {
    RCTWebViewManager.execute(this.getWebViewHandle(), js);
  },
